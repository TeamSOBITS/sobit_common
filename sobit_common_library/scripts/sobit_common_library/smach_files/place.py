...
def place_object_for_game_controller(shift_x=-0.45, shift_y=0.0, shift_z=0.15, move_straight_x=0.21, move_back_x=-0.35):
    """
    指定したtf名[placeable_point]に物体を置く
    置いた後は、INITIAL_POSEに戻る
    Args:
    ...
    Return:
        True or False   : 把持に成功したならTrue, 失敗ならFalseを返す
    """
    response = joint_controller.move_gripper_to_target_for_game_controller('placeable_point', geometry_msgs.msg.Point(x=shift_x, y=shift_y, z=shift_z))
